...
></div>
      ...
      <div className="max-w-5xl mx-auto space-y-10 sm:space-y-16 relative z-10 mt-10">
        ...
        <div className="font-[poppins]  px-4 sm:px-6 md:px-8">
          <p className="text-justify text-lg sm:text-xl md:text-xl leading-relaxed">
          ...
          <ul className="space-y-4 text-lg sm:text-xl md:text-xl leading-snug mt-6">
            {[
