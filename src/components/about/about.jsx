...
export default function About() {
    ...
    <>
      <div className="min-h-screen">
        ...
        <div className="py-16 px-4 flex justify-center w-full mb-[6vw]">
          <div className="">
            <div className="flex gap-4 justify-evenly items-center w-[90vw] px-6">
              ...
              >
                <div className="relative rounded-tl-4xl rounded-br-4xl ">
                  <div className="absolute inset-0 bg-gradient-to-br from-orange-500 to-red-500 rounded-tl-[5vw] rounded-br-[5vw] shadow-lg w-[30vw] h-full"></div>
                  <div className="relative rounded-3xl rounded-tl-[5vw] rounded-br-[5vw] p-2 translate-y-2 translate-x-2">
                    <Image
                      src={AboutSection}
                      alt="Teacher helping student at computer"
                      className="h-[30vw] w-[30vw] rounded-tl-[5vw] rounded-br-[5vw] object-cover shadow-lg"
                    />
                  </div>
                </div>
              </motion.div>
  ...
  className="flex flex-col space-y-8 px-8 py-6 w-[47vw] h-[30vw] "
>
  ...
  >
    <div className="inline-flex items-center px-2 py-2 bg-[#20356B] text-white rounded-full text-sm font-medium mb-2">
      <span className="w-2 h-2 bg-[#E85222] rounded-full mr-3"></span>
      <span className="text-[12px] font-bold">about us</span>
      <span className="w-2 h-2 bg-[#E85222] rounded-full ml-3"></span>
    </div>
  </motion.div>
  ...
  >
    <h1 className="text-[2.8vw] font-bold text-gray-900 leading-tight">
      We have the Best Teachers
    </h1>
    <h1 className="text-[2.8vw]  -mt-4 font-bold text-center text-gray-900 leading-tight">
      available in the City
    </h1>

    <div className="leading-relaxed text-[1.3vw] ml-[1vw] font-radley">
      Established in 1990. Successfully trained more than 20000
      <p className="text-center mr-6">
...
>
  <div className="relative"> {/* Added wrapper div */}
    <span className="block"> {/* Changed to block element */}
      <span className="text-[3vw] font-semibold font-radley text-blue-900 -mt-[3vw] block"> {/* Added -mt-[3vw] and block */}
        Established <span className='text-black'>in 1990.</span>
      </span>{' '}
    </span>

    <p className="mt-0 text-[1.3vw] tracking-wide text-black font-radley"> {/* Removed -mt-12 */}
    ...
    <p className="text-[1.3vw] tracking-wide text-black font-radey">
  ...
  >
    ...
    <p className="text-center text-2xl font-bold font-poppins uppercase py-6 z-20 mt-8">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
    ...
    <motion.div
      ref={left1Ref}
      initial={{ x: -100, y: -50, opacity: 0 }} // Comes from top-left
      animate={inViewLeft1 ? { x: 0, y: 0, opacity: 1 } : {}}
      transition={{ duration: 0.6 }}
      className="relative"
    >
      <div className="absolute w-[40vw] h-[20vw] bg-[#E85222] rounded-tl-[120px] shadow-md transform -translate-y-4 -translate-x-4"></div>
      <div className="relative z-10 w-[40vw] h-[20vw] bg-[#20356B] text-white p-6 flex justify-center items-center gap-8 flex-col rounded-tl-[120px] shadow-lg">
        <h2 className="text-4xl font-semibold mb-3">OUR VISION</h2>
        <p className="text-2xl text-center">To be a preferred center for providing quality education.</p>
      </div>
    </motion.div>
    ...
    <motion.div
      ref={right1Ref}
      initial={{ x: 100, y: -50, opacity: 0 }} // Comes from top-right
      animate={inViewRight1 ? { x: 0, y: 0, opacity: 1 } : {}}
      transition={{ duration: 0.6, delay: 0.1 }}
      className="w-[27vw] h-[17vw] bg-[#F9B233] text-black py-[1vw] rounded-tr-[120px] shadow-lg ml-4 mb-4 mt-[3vw]"
    >
      <h2 className="text-2xl font-semibold mb-6 text-center">OUR CULTURE</h2>
      <ul className="list-disc list-inside space-y-1 text-[12px] leading-relaxed px-14 font-bold">
        <li>Commitment</li>
    ...
    <motion.div
      ref={left2Ref}
      initial={{ x: -100, y: 50, opacity: 0 }} // Comes from bottom-left
      animate={inViewLeft2 ? { x: 0, y: 0, opacity: 1 } : {}}
      transition={{ duration: 0.6 }}
      className="w-[27vw] h-[17vw] bg-[#F9B233] text-black py-[1vw] rounded-bl-[120px] shadow-lg ml-auto -mt-[1vw] mr-[1vw]"
    >
    ...
    <motion.div
      ref={right2Ref}
      initial={{ x: 100, y: 50, opacity: 0 }} // Comes from bottom-right
      animate={inViewRight2 ? { x: 0, y: 0, opacity: 1 } : {}}
      transition={{ duration: 0.6, delay: 0.1 }}
      className="relative w-[40vw] h-[20vw]"
    >
      <div className="absolute w-[40vw] h-[20vw] bg-[#20356B] rounded-br-[120px] shadow-lg transform translate-y-4 translate-x-4"></div>
      <div className="relative z-10 w-[40vw] h-[20vw] bg-[#E85222] text-white p-6 flex justify-center items-center gap-8 flex-col rounded-br-[120px] shadow-lg">
        ...
        <p className="text-2xl text-center">To create passion for learning and contribute to developing student's learning graph through quality education.</p>
      </div>
    </motion.div>
  </div>
</div>
      ...
      <div className="flex flex-col lg:flex-row justify-evenly px-4 pb-[2vw] gap-4 overflow-hidden ">
        ...
        >
          <div className="text-4xl tracking-wider leading-relaxed text-black font-poppins ">
            <span className="text-[2vw] font-semibold text-blue-900">From The</span>
            <br />
            <span className="text-[2.6vw] text-[#E85222] font-bold uppercase">Principle's desk</span>
            <br />
            <span className='text-[2vw] font-bold italic mb-2 block'>
              "The whole purpose of education is to turn mirrors in to windows."
            </span>
          </div>
          <p className='mt-4 text-[1.2vw]  '>
  ...
  />
      ...
      <div
        ref={ref}
        className="bg-[#20356B] py-[2vw] text-white flex flex-col items-center  "
      >
