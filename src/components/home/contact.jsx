...
>
  ...
  >
    <FaSquareFacebook
      ...
      style={{ color: "#1877F2", fontSize: "100px" }}
    />
  </motion.a>

  {/* YouTube - Come from Top */}
  <motion.a
  ...
  >
    <FaSquareInstagram
      className="social-icon"
      style={{ color: "#C13584", fontSize: "100px" }}
    />
  </motion.a>

  {/* Justdial - Come from Right */}
  <motion.a
