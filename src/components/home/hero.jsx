      ...
      <div className="relative w-full h-full overflow-visible">
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden">
          ...
          >
            ...
            >
           <h1 className="text-[4.5vw] capitalize leading-tight mb-[0.3vw] font-lisubosa">
  Committed to
</h1>
<span style={{ fontFamily: '"Lisu Bosa", sans-serif' }} className="text-[#E85222] text-[4.5vw] capitalize">
  qulaity
</span>

<p className="text-[4.5vw] mb-[0.4vw] capitalize font-lisubosa">education</p>
